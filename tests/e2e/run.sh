...
suite() {  # name  script  port  schema(full|pre015|pre016)
  ...
  for f in migrations/*.sql; do
    case "$UPTO" in
      pre015) case "$f" in *015_*|*016_*|*018_*|*019_*|*020_*|*021_*|*022_*|*023_*) continue;; esac ;;
      pre016) case "$f" in *016_*|*018_*|*019_*|*020_*|*021_*|*022_*|*023_*) continue;; esac ;;
      pre018) case "$f" in *018_*|*019_*|*020_*|*021_*|*022_*|*023_*) continue;; esac ;;
      pre019) case "$f" in *019_*|*020_*|*021_*|*022_*|*023_*) continue;; esac ;;
      pre020) case "$f" in *020_*|*021_*|*022_*|*023_*) continue;; esac ;;
      pre021) case "$f" in *021_*|*022_*|*023_*) continue;; esac ;;
      pre022) case "$f" in *022_*|*023_*) continue;; esac ;;
      pre023) case "$f" in *023_*) continue;; esac ;;
    esac
