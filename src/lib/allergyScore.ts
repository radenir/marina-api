...
Also write ONE concise, direct sentence naming the single most impactful detail to add. Return "" for the suggestion when the status is "no_known_allergies" or when every axis is already "complete".
