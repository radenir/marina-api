...
Also write ONE concise sentence naming the specific findings still to examine and document, covering the applicable questions that are not yet complete — do not just pick one. Return "" if nothing applicable is missing.
