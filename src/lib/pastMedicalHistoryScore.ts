...
Also write ONE concise, direct sentence naming the single most valuable past-history topic still to ask about or clarify. Return "" if every axis is already "complete".
