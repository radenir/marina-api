...
Also write ONE short, DIRECT QUESTION to ask the patient about the single most useful past-health detail still missing. Keep it concise, to the point, and easy for anyone to understand: no medical jargon or abbreviations (for example "Have you had any operations before?"). Return "" if every axis is already "complete".
